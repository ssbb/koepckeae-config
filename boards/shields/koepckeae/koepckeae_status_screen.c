...
#if IS_ENABLED(CONFIG_KOEPCKEAE_BONGO_CAT)
#include "koepckeae_bongo_cat_widget.h"

static struct koepckeae_bongo_cat_widget bongo_widget;
...
#if IS_ENABLED(CONFIG_KOEPCKEAE_BONGO_CAT)
  koepckeae_bongo_cat_widget_init(&bongo_widget, center_frame);
#else
...
#endif // IS_ENABLED(CONFIG_KOEPCKEAE_BONGO_CAT)
